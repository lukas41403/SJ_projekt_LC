    ...
    <body>
        <main>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="/SJ_projekt_LC/index.php">
                        <img src="/SJ_projekt_LC/uploads/images/FCVO.webp" height="45" alt="FC Výčapy-Opatovce" class="me-2">
                        FC Výčapy-Opatovce
                    </a>
